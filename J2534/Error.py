...
J2534Error[ERR_NOT_SUPPORTED] = (ERR_NOT_SUPPORTED, 'ERR_NOT_SUPPORTED',
                                 'Device cannot support requested functionality mandated in this document. Device is not fully SAE J2534 compliant')
...
J2534Error[ERR_INVALID_PROTOCOL_ID] = (ERR_INVALID_PROTOCOL_ID,'ERR_INVALID_PROTOCOL_ID', 'Invalid ProtocolID value, unsupported ProtocolID, or there is a resource conflict (i.e. trying to connect to multiple protocols that are mutually exclusive such as J1850PWM and J1850VPW, or CAN and SCI A, etc.)')
